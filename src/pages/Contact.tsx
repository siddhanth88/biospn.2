      ...
      <section className={`py-20 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            <Reveal className={`p-8 rounded-xl text-center ${
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Reveal className={`p-8 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center space-x-2 px-6 py-4 btn-primary btn-shine"
                  >
            ...
            <div className="space-y-8">
              <Reveal className={`p-8 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg h-96`}>
